# Generated by Django 3.2.12 on 2023-08-07 00:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('pm', 'Project Manager'), ('se', 'Software Engineer'), ('ta', 'Test Analyst'), ('qa', 'Quality Assurance Spec.'), ('ro', 'Read-Only')], default='ro', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bugs_assigned', to=settings.AUTH_USER_MODEL)),
