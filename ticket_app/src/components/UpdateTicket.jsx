...
export default function UpdateTicket() {
    ...
    const handleSubmit = async (e) => {
      ...
      let response = await api.put(`companies/${company.id}/ticket/${ticket.id}/`,{
        feature: feature,
        notes: note,
                  ...
                  <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                      ...
                      <div className="relative">
                        ...
                        <div className="mt-4">
                            ...
                            {company && company.employees.map((employee, index) => (
                        ...
                        <div className="mt-4">
                            ...
                            className="w-4/6 text-black mx-4 rounded pl-1">
                                <option key={1} value={'na'}>Not Assigned</option>  
                                <option key={2} value={'ip'}>In Progress</option>  
                                <option key={3} value={'te'}>Testing</option>  
                                <option key={4} value={'qa'}>Verified</option>  
                                <option key={5} value={'ok'}>Approved</option>  
